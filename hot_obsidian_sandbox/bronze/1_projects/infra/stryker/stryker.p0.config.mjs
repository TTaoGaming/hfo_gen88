...
export default {
  ...
  mutate: ["hot_obsidian_sandbox/bronze/P0_LIDLESS_LEGION/contracts/index.ts"],
  ...
  disableBail: true,
  jsonReporter: { fileName: "hot_obsidian_sandbox/bronze/P0_LIDLESS_LEGION/mutation-report.json" }
};
