...
export default {
  ...
  mutate: ["hot_obsidian_sandbox/bronze/P7_SPIDER_SOVEREIGN/contracts/index.ts"],
  ...
  disableBail: true,
  jsonReporter: { fileName: "hot_obsidian_sandbox/bronze/P7_SPIDER_SOVEREIGN/mutation-report.json" }
};
