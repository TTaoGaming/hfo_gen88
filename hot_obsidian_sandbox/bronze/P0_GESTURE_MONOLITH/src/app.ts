...
export class GestureMonolithApp {
  ...
  private sensorStage: SensorStage;
  ...
  constructor(container: HTMLElement) {
    ...
    // Create stages
    this.sensorStage = new SensorStage({}, this.eventTarget);
    ...
    this.settingsPanel = new SettingsPanel({
      ...
      onStartLive: async () => {
        const stream = await this.sensorStage.startCapture();
        this.webcamPanel.setStream(stream);
      },
      onStopLive: () => this.sensorStage.stop(),
    });
