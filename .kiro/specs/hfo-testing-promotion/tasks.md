...
- [ ] 13. Update bronze wrappers to use silver modules
  - [ ] 13.1 Update bronze ledger to import silver core
    - Keep I/O in bronze, use silver for hash computation
    - _Requirements: 1.1_
  - [ ] 13.2 Update bronze runner to import silver modules
    - Import Semaphore, Fitness from silver
    - _Requirements: 5.1_
  - [ ] 13.3 Verify bronze integration tests still pass
