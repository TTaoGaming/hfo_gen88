...
/**
 * P4 RED REGNANT Core - Mutation Testing Config
 * @port 4
 * @target score-classifier.ts (PARA: 2_areas/hfo_ports)
...
export default {
  ...
  mutate: [
    "hot_obsidian_sandbox/bronze/2_areas/hfo_ports/P4_RED_REGNANT/core/score-classifier.ts"
  ],
  ...
  ignorePatterns: [
    ...
    "hot_obsidian_sandbox/bronze/2_areas/hfo_ports/P5_*/**",
  ...
  tempDirName: ".stryker-tmp-p4-core",
  cleanTempDir: "always",
  
  jsonReporter: {
    fileName: "reports/mutation-p4-core.json"
  }
};
