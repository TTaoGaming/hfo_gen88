...
export const ROOT_DIR = path.resolve(__dirname, '../../../../'); // Ascend from 2_areas/hfo_ports/P4_RED_REGNANT/
...
export const PORTS_DIR = path.join(BRONZE_DIR, '2_areas/hfo_ports');
export const BLACKBOARD_PATH = path.join(HOT_DIR, 'hot_obsidianblackboard.jsonl');
export const RED_BOOK_PATH = path.join(PORTS_DIR, 'P4_RED_REGNANT/RED_BOOK_OF_BLOOD_GRUDGES.jsonl');
export const BLOOD_BOOK_PATH = path.join(PORTS_DIR, 'P4_RED_REGNANT/BLOOD_BOOK_OF_GRUDGES.jsonl');

const isTest = process.env.HFO_TEST_MODE === 'true';
const dbPath = isTest ? ':memory:' : path.join(PORTS_DIR, 'P4_RED_REGNANT/blood_book.db');
...
export const ALLOWED_ROOT_FILES = [
    ...
    'ROOT_GOVERNANCE_MANIFEST.md', 'package.json', 'package-lock.json',
